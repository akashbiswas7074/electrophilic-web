            ...
            <div className="flex items-center justify-between h-16">
              ...
              <Link href="/" className="flex items-center relative z-10 group md:left-0 px-3">
                {showLogoImage ? (
                  ...
                  <div className="relative h-10 w-36 transition-all duration-300 group-hover:opacity-80">
                    <span className="text-gray-900 text-xl font-bold tracking-wider">{logoText}</span>
                  </div>
                )}
              </Link>
              ...
              <div className="flex items-center gap-3">
                ...
                <button 
                  ...
                  className="md:hidden p-2.5 hover:bg-black/5 rounded-full transition-all duration-300 active:scale-95 hover:shadow-sm text-gray-800"
                >
