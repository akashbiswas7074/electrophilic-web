  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in": "fade-in 0.2s ease-out", // Original fade-in using 'fade-in' keyframes
        ...
        "fadeIn": "fadeIn 0.5s ease-out forwards", // Renamed from "fade-in" to use 'fadeIn' keyframes
